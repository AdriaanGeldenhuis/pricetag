                    ...
                    <form id="pt-product-form">
                        ...
                        <div class="pt-purchase">
                            ...
                            <div class="pt-actions">
                                ...
                                <button type="button" class="pt-btn-wish<?= !empty($inWishlist) ? ' is-active' : '' ?>" data-wishlist-toggle="<?= $product->id ?>" aria-label="<?= !empty($inWishlist) ? 'Remove from wishlist' : 'Add to wishlist' ?>" aria-pressed="<?= !empty($inWishlist) ? 'true' : 'false' ?>">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
                                </button>
                                <button type="button" class="pt-btn-wish" data-quote-add="<?= $product->id ?>" aria-label="Add to quote" title="Add to Quote">
