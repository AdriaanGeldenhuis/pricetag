    ...
    <div class="mobile-menu-panel" role="dialog" aria-label="Mobile navigation">
        ...
        <div class="mobile-menu-body">
            ...
            <div class="mobile-quick-links">
                <a href="<?= url('/categories') ?>" class="mobile-quick-pill">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                    </svg>
                    Featured
                </a>
                <a href="<?= url('/categories') ?>" class="mobile-quick-pill mobile-quick-sale">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <nav class="mobile-nav-links">
                ...
                <a href="<?= url('/categories') ?>" class="mobile-nav-row">
